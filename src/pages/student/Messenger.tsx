  ...
  return (
    <div className="h-screen">
      ...
      <div className="flex h-full">
        ...
        {(!viewChat || desktop) && (
          ...
          >
            <input
              ...
              className="w-full p-2 border-b border-gray-300 hidden"
            />
        ...
        {(desktop || viewChat) && (
          <div
            className={`${mobile ? "w-full" : "w-1/2 "}flex flex-col relative`}
            style={{ height: "90%" }}
          >
         { currentChat ?  <div className="flex items-center gap-1 p-4">
            ...
            </div>:<div className="h-full flex flex-col justify-center items-center"><p className="text-3xl font-medium">Please select a someone from left</p><p>Feel free to ask for notes and clear doubts</p></div>}
